...
# Currently this is not strand-specific as "bamCoverage" doesn't allow it, but filtering out overlapping genes should take care of most of the problems.  
# Alternatively, one could filter the bam file by strand prior to calculating coverage.
sigs.list <- list()
