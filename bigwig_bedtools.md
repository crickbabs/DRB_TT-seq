...
This alternative to "bigwig.sh" uses bedtools (Quinlan, *et al* 2014) rather than deeptools to generate bedgraph files which are in turn converted to bigwig via Jim Kent's BigWig and BigBed tools (kent, *et al*, 2010).  It is more able to deal with large bam files.
